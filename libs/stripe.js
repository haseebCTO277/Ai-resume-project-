...
// This is used to create a Stripe Checkout for one-time payments or subscriptions. It's usually triggered with the <ButtonCheckout /> component. Webhooks are used to update the user's state in the database.
export const createCheckout = async ({
  ...
  const stripeSession = await stripe.checkout.sessions.create({
    mode,
    allow_promotion_codes: true, // This enables the built-in Stripe promotion code field
