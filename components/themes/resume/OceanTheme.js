...
export default function OceanTheme({
  ...
  const [hoveredResponsibility, setHoveredResponsibility] = useState({
    expIndex: null,
    resIndex: null,
  });
  ...
  return (
    ...
    >
      ...
      >
        <section
          className="text-white w-[30%] h-full pt-2 pb-10"
          style={{ backgroundColor: "white", ...rtlStyle }}
        >
          {!print ? (
            <div className="px-3">
              <textarea
            ...
            <div className="px-3">
              ...
              <div
                ...
                style={{
                  ...
                  ...rtlStyle,
                  lineHeight: `${
                    fontFamily === "Amiri Quran" ? "35px" : "inherit"
                  }`,
                }}
              >
          ...
          <section className="mt-3" style={rtlStyle}>
            ...
            <ul
              className="mt-2 px-3 max-w-[70%] flex flex-col gap-2"
              style={{
                color: fullNameColor,
                whiteSpace: "pre-wrap",
                wordWrap: "break-word",
            ...
            >
              ...
              <li className="text-[13px]">
                ...
                {!print ? (
                  ...
                  <div
                    className="text-[12px] opacity-80 flex flex-col bg-transparent border-none outline-none w-fit"
                    style={{
                      color: fullNameColor,
                      whiteSpace: "pre-wrap",
                      wordWrap: "break-word",
          ...
          >
            ...
            <ul
              className="mt-1 px-2 w-[100%] flex flex-col gap-2"
              style={rtlStyle}
            >
        ...
        {/* RIGHT COLUMN */}
        <aside
          className="w-[70%] flex flex-col gap-1 px-4 py-4"
          style={{ backgroundColor: fullNameColor, ...rtlStyle }}
        >
          {/* SUMMARY */}
          <section
          ...
          <section
            ...
            style={rtlStyle}
          >
            <h1 className="font-bold border-b-2 border-b-black text-white">
              {t.experience}
            </h1>
              ...
              {(resumeData.experiences || []).map((experience, index) => (
                <li
                  ...
                  className={`relative transition-all duration-300 ${
                    hoveredExperience === index ? "mt-10 mb-10" : "mt-1 mb-1"
                  }`}
                >
                  <div
                    className={`flex items-center gap-1 font-bold text-[13px] ${
                      hoveredExperience === index ? "pt-4 pb-4" : "pt-1 pb-1"
                    }`}
                    style={{ maxWidth: "95%" }}
                  >
                    <input
                      className="font-bold bg-transparent border-none outline-none text-white w-[25%]"
                  ...
                  <div
                    className="ml-5 text-[13px]/[17px] mt-1 relative text-white"
                ...
                >
                  <div className="w-full flex items-center justify-between ">
                    {!print ? (
                      ...
                      <div
                        className="text-[13px] border-b-2 w-fit resize-none overflow-hidden bg-transparent border-none outline-none text-white"
                        style={rtlStyle}
                      >
                        {edu.institution || ""}
                      </div>
          ...
          {sectionsVisibility.extraDetailedSection && (
            <section
              className={`mt-5 relative group ${
                generatingSection === "extraDetailedSection" ? "generating" : ""
              }`}
              style={rtlStyle}
            >
              <h1 className="font-bold border-b-2 border-b-black text-white">
              ...
              <ul>
                {(resumeData.extraDetailedSection || []).map(
                  (extraDetail, index) => (
                    <li
                      key={index}
                      onMouseEnter={() => setHoveredExtraDetailedSection(index)}
                      onMouseLeave={() => setHoveredExtraDetailedSection(null)}
                      className={`relative transition-all duration-300 ${
                    ...
                    >
                      ...
                      <ul className="ml-5 list-disc text-[13px]/[17px] mt-1 relative w-full text-white">
                        {(extraDetail.details || []).map((detail, resIndex) => (
                          ...
                          >
                            {hoveredExtraDetailedSectionDetail.expIndex ===
                              index &&
                              hoveredExtraDetailedSectionDetail.resIndex ===
                                resIndex && (
                                <button
                                  onClick={() =>
                                    removeExtraDetailedSectionDetail(
