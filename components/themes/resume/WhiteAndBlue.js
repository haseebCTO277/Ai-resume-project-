...
export default function WhiteAndBlue({
  ...
  return (
    ...
    >
      <main
        className="w-full max-w-[800px] flex-grow flex text-black "
        style={{
      ...
      >
        ...
        <section
          className="w-[70%] flex flex-col gap-0 px-4 py-2 z-[100]"
          style={{
            fontFamily: fontFamily,
            backgroundColor: "white",
            ...rtlStyle,
                ...
                >
                  <div
                    className={`flex items-center gap-1 font-bold text-[13px] ${
                      hoveredExperience === index ? "pt-2 pb-2" : "pt-0 pb-0"
                    }`}
        ...
        <aside
          className="text-white w-[30%] flex flex-col gap-0 py-2 z-0"
          style={{
